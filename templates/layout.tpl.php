...
$user_avatar = 'http://yeticave/img/user.jpg';
$title = 'Главная - шаблон';
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <link href="http://yeticave/css/normalize.min.css" rel="stylesheet">
    <link href="http://yeticave/css/style.css" rel="stylesheet">
</head>
<body>
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo">
            <img src="http://yeticave/img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
        </a>
